...
* [PARTE 1 — DIAGRAMA DE CLASSES DE ANÁLISE](#parte-1--diagrama-de-classes-de-análise)
* [PARTE 2 — DIAGRAMA DE TRANSIÇÃO DE ESTADOS (DTE)](#parte-2--diagrama-de-transição-de-estados-dte)
* [PARTE 3 — DIAGRAMAS DE INTERAÇÃO](#parte-3--diagramas-de-interação)
